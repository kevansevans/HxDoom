...
class GameCore
{
	...
	//Borrowed from the original Doom source code for vanilla behavior
	public var randomTable:Array<Int> = [
	...
	var mRandomIndex:Int = 0;
	var pRandomIndex:Int = 0;
	
	public function m_random():Int
	{
		return randomTable[(mRandomIndex + 1) & 0xFF];
	}
	
	public function p_random():Int
	{
		return randomTable[(pRandomIndex + 1) & 0xFF];
	}
}