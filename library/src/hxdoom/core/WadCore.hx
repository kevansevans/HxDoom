...
class WadCore 
{
	...
	public function loadPlaypal() {
		...
		var directory = directory_name_map[Lump.PLAYPAL][0];
	...
	public function loadMap(_mapMarker:String):Bool {
		...
		//Load things
		////////////////////////////////////////////////////////////////////////////////////////////////////
		if (directory_index_map[directory.wad][directory.index + 1].name != hxdoom.utils.enums.Lump.THINGS) {
		...
		//Load linedefs
		////////////////////////////////////////////////////////////////////////////////////////////////////
		if (directory_index_map[directory.wad][directory.index + 2].name != hxdoom.utils.enums.Lump.LINEDEFS) {
		...
		//Load sidedefs
		////////////////////////////////////////////////////////////////////////////////////////////////////
		if (directory_index_map[directory.wad][directory.index + 3].name != hxdoom.utils.enums.Lump.SIDEDEFS) {
		...
		//Load vertexes
		////////////////////////////////////////////////////////////////////////////////////////////////////
		if (directory_index_map[directory.wad][directory.index + 4].name != hxdoom.utils.enums.Lump.VERTEXES) {
		...
		//Load segments
		////////////////////////////////////////////////////////////////////////////////////////////////////
		if (directory_index_map[directory.wad][directory.index + 5].name != hxdoom.utils.enums.Lump.SEGS) {
		...
		//Load Subsectors
		////////////////////////////////////////////////////////////////////////////////////////////////////
		if (directory_index_map[directory.wad][directory.index + 6].name != hxdoom.utils.enums.Lump.SSECTORS) {
		...
		//Load nodes
		////////////////////////////////////////////////////////////////////////////////////////////////////
		if (directory_index_map[directory.wad][directory.index + 7].name != hxdoom.utils.enums.Lump.NODES) {
		...
		//Load sectors
		////////////////////////////////////////////////////////////////////////////////////////////////////
		if (directory_index_map[directory.wad][directory.index + 8].name != hxdoom.utils.enums.Lump.SECTORS) {
